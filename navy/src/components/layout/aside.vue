<template>
  <div class="aside" ref='aside' :style="{background:asideBg}">
    <div class="logo">
...
export default {
    ...
    data:function(){
     return{
       ...
       {'icon':'#index','title':'dataTable','show':false,'content':[
         {'name':'表格1','router':'/main/table1'},
         {'name':'表格2','router':'/main/table2'},
         {'name':'表格3','router':'/main/table3'}
         ]},
       {'icon':'#echarts','title':'Echarts','show':false,'content':[
         {'name':'可视化1','router':'/main/echarts1'},
         {'name':'可视化2','router':'/main/echarts2'},
         ]}
      ],
      active:-1,
     }
    ...
    computed:{
      ...mapGetters(['asideState','asideEl','switchesEl','mainContainerEl','topEl','asideBg']),
    },
    mounted:function(){
...
<style>
  .aside{
    ...
    width: 250px;
    height: 100vh;
    /*background: url(../../../static/bg_aside.png) center no-repeat;*/
