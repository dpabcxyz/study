<template>
  <li class="switches" :style="{color:navTopTxt}" @click="switches" ref='switches'>
...
<script>
  ...
  export  default{
    name:'Switches',
    computed: {
       ...mapGetters(['asideEl','asideState','mainContainerEl','topEl','logoSymbolEl','logoTextEl','navTopTxt']),
    },
    mounted:function(){
